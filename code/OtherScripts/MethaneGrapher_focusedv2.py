...
INPUT_CSV = r"C:\Users\zerru001\OneDrive - Wageningen University & Research\Paper1\RUN2\CSV\KOR-CRK_2018_cm.csv"  # ← adjust path to your CSV file
SITE_NAME = "KOR-CRK_2018"  # Used in plot titles and output filenames
OUTPUT_DIR = r"C:\Users\zerru001\OneDrive - Wageningen University & Research\Paper1\RUN2\Graphs\KOR\new_graphs_v2"  # ← adjust path to your desired output directory
...
def make_focused_plot(df, site_name):
    ...
    FS_TITLE, FS_LABEL, FS_LEG, FS_TICK, FS_AVG = 26, 24, 22, 21, 18
