...
OUTPUT_DIR = r"C:\Users\zerru001\OneDrive - Wageningen University & Research\Paper1\RUN2\PYSR\JPN\Metadata\rerun_04Aug2026"
...
MAXSIZE = 25             # v6.4: was 35. ORYZA embedding wants 10-20 nodes, so the top third of the
...
BATCHING = True # default was False 
BATCH_SIZE = 1024
...
def run_multiseed_pipeline(csv_path, out_root, run_ts, n_seeds, base_seed=42):
    ...
    if reps is not None:
        ...
        print(f"\n  Stage 8 will validate {len(forms)} recurring form(s):")
        ...
        print(f"             Reverting to Rule A, seed {rule_a_winner['seed']}. "
